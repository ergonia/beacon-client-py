...
class BeaconEndpoints:
    ...
    def _check_state_id(state_id: StateId) -> None:
        if isinstance(state_id, str) and not state_id.startswith("0x"):
            assert state_id in ["head", "genesis", "finalized", "justified"], \
    ...
    def get_validators_from_state(
        ...
        return self._query_url(f"/eth/v1/beacon/states/{state_id}/validators", params=params)
    ...
    def get_validators_balances_from_state(self, state_id: StateId, validator_list: Union[list, None] = None) -> dict:
        '''
        ...
        return self._query_url(f"/eth/v1/beacon/states/{state_id}/validator_balances", params=params)
    ...
    def get_committees_from_state(
        ...
        return self._query_url(f"/eth/v1/beacon/states/{state_id}/committees", params=params)
    
    def get_sync_committees_from_state(self, state_id, epoch: Union[int, None] = None) -> dict:
        '''
        ...
        return self._query_url(f"/eth/v1/beacon/states/{state_id}/sync_committees", params=params)
    
    def get_headers(self, slot: Union[int, None] = None, parent_root: Union[str, None] = None) -> dict:
        '''
    ...
    def get_pool_attestations(
        self, 
        slot: Union[int, None] = None, 
        committee_index: Union[int, None] = None
    ) -> dict:
        '''
